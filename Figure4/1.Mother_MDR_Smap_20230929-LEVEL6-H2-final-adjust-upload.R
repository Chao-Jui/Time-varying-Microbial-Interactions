...
rm(list = ls())
# Set path
Root_Path <- 'D:\\.......\\level_6_H2_final_adjust\\'
Sub_Path <- '\\'
...
envi <- read.csv(paste(Root_Path,'\\Data\\UASB_ENV_table_20230929_upload.csv',sep=''),header=T,stringsAsFactors = F, check.names = F)
do=t(do[,-1]);
