...
month.dat=read.csv("UASB_109_v2.csv",header=T,fill=T)
n=nrow(month.dat) # time series length
vb=c('date','day','COD',"dG",'Ac','Pr','Bu','H2','CH4','pH','PC1','PC2','Div_a','Biomass','Instability','P_P_IS','P_N_IS','Complexity','Ave_P_IS','Ave_N_IS','Centrality')# rename the variables
...
indmat=matrix(0,19*19,2);colnames(indmat)=c('Effect','Cause')
indmat[,1]= rep(c('COD',"dG",'Ac','Pr','Bu','H2','CH4','pH','PC1','PC2','Div_a','Biomass','Instability','P_P_IS','P_N_IS','Complexity','Ave_P_IS','Ave_N_IS','Centrality'), each = 19)
indmat[,2]= rep(c('COD',"dG",'Ac','Pr','Bu','H2','CH4','pH','PC1','PC2','Div_a','Biomass','Instability','P_P_IS','P_N_IS','Complexity','Ave_P_IS','Ave_N_IS','Centrality'), times = 19)
indmat
...
#Lable factor type
indmat_type=matrix(0,19*19,2);colnames(indmat)=c('Effect_type','Cause_type')
indmat_type[,1]= rep(c('Metabolites',"Metabolites",'Metabolites','Metabolites','Metabolites','Metabolites','Metabolites','Metabolites','Community','Community','Community','Community','Interaction','Interaction','Interaction','Interaction','Interaction','Interaction','Interaction'), each = 19)
indmat_type[,2]= rep(c('Metabolites',"Metabolites",'Metabolites','Metabolites','Metabolites','Metabolites','Metabolites','Metabolites','Community','Community','Community','Community','Interaction','Interaction','Interaction','Interaction','Interaction','Interaction','Interaction'), times = 19)
indmat_type
...
write.csv(linkM.std,'ccmda_UASB_dtrend_T_dTtype_linear_v3_all_combination.csv',row.names=F)
